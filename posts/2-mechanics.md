...
If the task should be easier because of your background or circumstances, add D6 Base Die to the roll

### Disadvantage

If task should be more difficult, remove D6 Base Die from the roll.

### Help

Helping player gives his Skill Die that can be used by another player instead of his Base Die.
